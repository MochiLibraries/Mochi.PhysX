...
public unsafe static partial class PxD6JointCreate
{
    ...
    public static extern PxJoint* PxD6JointCreate_Fixed(PxPhysics* physics, PxRigidActor* actor0, PxVec3* localPos0, PxRigidActor* actor1, PxVec3* localPos1, bool useD6);
    ...
    public static extern PxJoint* PxD6JointCreate_Distance(PxPhysics* physics, PxRigidActor* actor0, PxVec3* localPos0, PxRigidActor* actor1, PxVec3* localPos1, float maxDist, bool useD6);
    ...
    public static extern PxJoint* PxD6JointCreate_Prismatic(PxPhysics* physics, PxRigidActor* actor0, PxVec3* localPos0, PxRigidActor* actor1, PxVec3* localPos1, PxVec3* axis, float minLimit, float maxLimit, bool useD6);
    ...
    public static extern PxJoint* PxD6JointCreate_Revolute(PxPhysics* physics, PxRigidActor* actor0, PxVec3* localPos0, PxRigidActor* actor1, PxVec3* localPos1, PxVec3* axis, float minLimit, float maxLimit, bool useD6);
    ...
    public static extern PxJoint* PxD6JointCreate_Spherical(PxPhysics* physics, PxRigidActor* actor0, PxVec3* localPos0, PxRigidActor* actor1, PxVec3* localPos1, PxVec3* axis, float limit1, float limit2, bool useD6);
    ...
    public static extern PxJoint* PxD6JointCreate_GenericCone(float* apiroty, float* apirotz, PxPhysics* physics, PxRigidActor* actor0, PxVec3* localPos0, PxRigidActor* actor1, PxVec3* localPos1, float minLimit1, float maxLimit1, float minLimit2, float maxLimit2, bool useD6);
