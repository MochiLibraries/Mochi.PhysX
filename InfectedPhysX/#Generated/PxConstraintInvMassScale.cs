...
namespace PhysX
{
    ...
    public unsafe partial struct PxConstraintInvMassScale
    {
        ...
        [DllImport("TODO.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "??0PxConstraintInvMassScale@physx@@QEAA@XZ", ExactSpelling = true)]
        ...
        [DllImport("TODO.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "??0PxConstraintInvMassScale@physx@@QEAA@MMMM@Z", ExactSpelling = true)]
        private static extern void Constructor_PInvoke(PxConstraintInvMassScale* @this, float lin0, float ang0, float lin1, float ang1);

        [DebuggerStepThrough, DebuggerHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe void Constructor(float lin0, float ang0, float lin1, float ang1)
        {
            fixed (PxConstraintInvMassScale* @this = &this)
