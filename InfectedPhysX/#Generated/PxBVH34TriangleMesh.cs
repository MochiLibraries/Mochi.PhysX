...
public unsafe partial struct PxBVH34TriangleMesh
{
    ...
    [DllImport("TODO.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "??0PxBVH34TriangleMesh@physx@@IEAA@GV?$PxFlags@W4Enum@PxBaseFlag@physx@@G@1@@Z", ExactSpelling = true)]
    private static extern void Constructor_PInvoke(PxBVH34TriangleMesh* @this, ushort concreteType, PxBaseFlags baseFlags);

    public unsafe void Constructor(ushort concreteType, PxBaseFlags baseFlags)
    {
        fixed (PxBVH34TriangleMesh* @this = &this)
        { Constructor_PInvoke(@this, concreteType, baseFlags); }
    }

    [DllImport("TODO.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "??0PxBVH34TriangleMesh@physx@@IEAA@V?$PxFlags@W4Enum@PxBaseFlag@physx@@G@1@@Z", ExactSpelling = true)]
    private static extern void Constructor_PInvoke(PxBVH34TriangleMesh* @this, PxBaseFlags baseFlags);
    ...
    public unsafe struct VirtualMethodTable
    {
        ...
        public delegate* unmanaged[Cdecl]<PxBVH34TriangleMesh*, void> __DeletingDestructorPointer;
        /// <summary>Virtual method pointer for `isKindOf`</summary>
        public delegate* unmanaged[Cdecl]<PxBVH34TriangleMesh*, byte*, NativeBoolean> isKindOf;
