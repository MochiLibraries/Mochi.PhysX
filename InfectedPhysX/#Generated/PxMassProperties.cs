...
public unsafe partial struct PxMassProperties
{
    ...
    private static extern void operator_Star_PInvoke(PxMassProperties* @this, out PxMassProperties __returnBuffer, float scale);
    ...
    public static extern void getMassSpaceInertia(out PxVec3 __returnBuffer, PxMat33* inertia, PxQuat* massFrame);
    ...
    public static extern void translateInertia(out PxMat33 __returnBuffer, PxMat33* inertia, float mass, PxVec3* t);
    ...
    public static extern void rotateInertia(out PxMat33 __returnBuffer, PxMat33* inertia, PxQuat* q);
    ...
    public static extern void scaleInertia(out PxMat33 __returnBuffer, PxMat33* inertia, PxQuat* scaleRotation, PxVec3* scale);
    ...
    public static extern void sum(out PxMassProperties __returnBuffer, PxMassProperties* props, PxTransform* transforms, uint count);
