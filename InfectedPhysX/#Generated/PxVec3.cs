...
public unsafe partial struct PxVec3
{
    ...
    private static extern void operator_Minus_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer);
    ...
    private static extern void operator_Plus_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, PxVec3* v);
    ...
    private static extern void operator_Minus_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, PxVec3* v);
    ...
    private static extern void operator_Star_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, float f);
    ...
    private static extern void operator_Slash_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, float f);
    ...
    private static extern void cross_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, PxVec3* v);
    ...
    private static extern void getNormalized_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer);
    ...
    private static extern void multiply_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, PxVec3* a);
    ...
    private static extern void minimum_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, PxVec3* v);
    ...
    private static extern void maximum_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer, PxVec3* v);
    ...
    private static extern void abs_PInvoke(PxVec3* @this, out PxVec3 __returnBuffer);
    ...
    public static extern void operator_Star(out PxVec3 __returnBuffer, float f, PxVec3* v);
}
