...
namespace Mochi.PhysX
{
    ...
    public unsafe partial struct PxBVH33MidphaseDesc
    {
        ...
        [DllImport("Mochi.PhysX.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?setToDefault@PxBVH33MidphaseDesc@physx@@QEAAXXZ", ExactSpelling = true)]
        ...
        [DllImport("Mochi.PhysX.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "?isValid@PxBVH33MidphaseDesc@physx@@QEBA_NXZ", ExactSpelling = true)]
