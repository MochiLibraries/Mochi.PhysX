...
public unsafe partial struct PxSceneDesc
{
    ...
    [FieldOffset(56)] public /* Failed to emit TranslatedNormalField filterShader: Failed to resolve `Ref resolved by PxFlags` during emit time. */
    /* Failed to emit TranslatedNormalField filterShader: Failed to resolve `Ref resolved by PxFlags` during emit time. */
    delegate* unmanaged[Cdecl]<uint, PxFilterData, uint, PxFilterData, int*, void*, uint, int>* filterShader;
